...
const TargetCursor = ({
  targetSelector = '.cursor-target, a, button, input, textarea, select, summary, [role="button"], [tabindex]:not([tabindex="-1"]), img, svg, [data-cursor-target]',
  spinDuration = 2,
  ...
  useEffect(() => {
    ...
    const enterHandler = (e) => {
      ...
      for (const el of path) {
        if (el && el.matches && el.matches(targetSelector)) {
          target = el;
          break;
        }
      }
